        ...
        return {
            ...
            visitor: {
                ...
                StringLiteral: (path, state) => {
                    ...
                    build_store_1.default.appEvents.set(importer, (_b = (_a = build_store_1.default.appEvents.get(importer)) === null || _a === void 0 ? void 0 : _a.add(node.value)) !== null && _b !== void 0 ? _b : new Set([node.value]));
                },
                Identifier: (path, state) => {
                    ...
                    build_store_1.default.appEvents.set(importer, (_b = (_a = build_store_1.default.appEvents.get(importer)) === null || _a === void 0 ? void 0 : _a.add(node.name)) !== null && _b !== void 0 ? _b : new Set([node.name]));
                },
            },
        };
    });
