    ...
    var config = {
        ...
        callLifecycle: function (lifecycle) {
            ...
            __spread(callbacks).map(function (callback) {
                result = index_1.unstable_batchedUpdates(function (args) {
