...
var transformReactStyleKey = function (key) {
    ...
    if (styleValue === null || styleValue === void 0 ? void 0 : styleValue.startsWith('-')) {
        ...
        if (framework_shared_1.find(vendorPrefixes, function (prefix) { return prefix === firstWord_1; })) {
...
var plainStyle = function (style) {
    return Object.keys(style)
        ...
        return __spread(acc, [transformReactStyleKey(key) + ":" + (framework_shared_1.RuntimeOptions.get('pxToRpx') ? transformPx(value) : value) + ";"]);
    }, [])
        .join('');
};
