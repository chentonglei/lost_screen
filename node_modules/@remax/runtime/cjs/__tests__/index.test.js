...
describe('ali remax render', function () {
    ...
    it('remove event listener when unmount', function () {
        var Page = /** @class */ (function (_super) {
            __extends(Page, _super);
            function Page() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
            ...
            Page.prototype.render = function () {
                return (React.createElement(View_1.default, null, this.state.show && (React.createElement(View_1.default, { ref: this.props.node, onClick: function () { return console.log('hello'); } }, "foo"))));
            };
            return Page;
        }(React.Component));
        var container = new Container_1.default(p);
        ...
        render_1.default(React.createElement(Page, { ref: page, node: node }), container);
        var nodeId = node.current.id;
        var contextKey = constants_1.REMAX_METHOD + "_" + nodeId + "_onClick";
