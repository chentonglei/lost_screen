...
describe('page', function () {
    ...
    it('call useEffect', function (done) {
        var Foo = React.forwardRef(function (props, ref) {
            ...
            src_1.usePageEvent('onShow', function updateState() {
                upV1(2);
                upV2(2);
        ...
        var page = Page_1.default(createPageConfig_1.default(function () { return React.createElement(Foo, null); }, TEST_PAGE));
        page.load();
        page.unload();
    });
