...
describe('wechat remax render', function () {
                ...
                case 0:
                    ...
                    App = /** @class */ (function (_super) {
                        ...
                        App.prototype.render = function () {
                            ...
                            return (React.createElement(React.Fragment, null,
                                React.createElement(View, { id: "1" },
                                    React.createElement(View, { id: "2" }, toggle ? React.createElement(View, { id: "3" }, "a") : React.createElement(View, { id: "3" }, "b")),
                                    !toggle && React.createElement(View, { id: "5" }, "safeAreaHeight"))));
                        };
                        return App;
                    }(React.Component));
                    ...
                    app = React.createRef();
                    render(React.createElement(App, { ref: app }), container);
                    app.current.toggle();
    ...
    it('swaps items', function () {
        ...
        var App = /** @class */ (function (_super) {
            ...
            App.prototype.render = function () {
                var list = this.state.list;
                return (React.createElement(View, { id: "1" }, list.map(function (item, index) { return (React.createElement(View, { key: item },
                    index,
                    item)); })));
            };
            return App;
                ...
                case 0:
                    ...
                    App = /** @class */ (function (_super) {
                        ...
                        App.prototype.render = function () {
                            ...
                            return React.createElement(View, { id: "a" }, a && React.createElement(View, { id: "b" }, b ? React.createElement(View, { id: "c" }, "a") : 'b'));
                        };
                        return App;
                    }(React.Component));
                    container = new Container({
            ...
            switch (_a.label) {
                case 0:
                    ...
                    App = /** @class */ (function (_super) {
                        ...
                        App.prototype.render = function () {
                            var _a = this.state, a = _a.a, b = _a.b;
                            return React.createElement(View, null, a && React.createElement(View, { style: { color: b ? 'red' : 'green' } }, "foo"));
                        };
                        return App;
                    }(React.Component));
                    container = new Container({
