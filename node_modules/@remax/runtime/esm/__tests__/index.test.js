...
describe('ali remax render', function () {
    ...
    it('remove event listener when unmount', function () {
        var Page = /** @class */ (function (_super) {
            ...
            Page.prototype.render = function () {
                return (React.createElement(View, null, this.state.show && (React.createElement(View, { ref: this.props.node, onClick: function () { return console.log('hello'); } }, "foo"))));
            };
            return Page;
        }(React.Component));
        var container = new Container(p);
        ...
        render(React.createElement(Page, { ref: page, node: node }), container);
        var nodeId = node.current.id;
        var contextKey = REMAX_METHOD + "_" + nodeId + "_onClick";
