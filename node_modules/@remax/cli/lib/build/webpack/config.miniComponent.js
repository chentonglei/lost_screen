...
function webpackConfig(builder) {
    ...
    config.module.rule('native-component').test(extensions_1.moduleMatcher).use('native-component').loader('nativeComponent').options({
        builder,
    });
    ...
    config.module
        ...
        .use('file')
        .loader(require.resolve('file-loader'));
    const runtimeOptionsTemplate = fs_1.default.readFileSync(path.resolve(__dirname, '../../../template/component-runtime-options.js.ejs'), 'utf-8');
