...
function webpackConfig(builder) {
    ...
    if (builder.options.target == 'toutiao' && fs_1.default.existsSync(miniProjectConfigJsonFile)) {
        config.plugin('webpack-copy-plugin').use(copy_webpack_plugin_1.default, [
            [
                {
